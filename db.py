...
class Users():
    ...
    def create_user(database: Database, nick: str, mail: str, password_hash: str, mobile_service_id=None) -> int:
        ...
        level = 1
        xp = 0
        database.insert(f"""INSERT INTO users (mobile_service_id, level, xp) VALUES ({mobile_service_id if mobile_service_id != None else 'null'}, {level}, {xp})""")
        ...
        database.insert(f"INSERT INTO login_users (id, nick, mail, psword_hash) VALUES({id_user}, '{nick}', '{mail}', '{password_hash}')")
        return id_user
...
class MobileServices():
    ...
    def create_mobile_service(database: Database, service_name: str, user_id: int):
        user_attraction = 1.0
        database.insert(f"""INSERT INTO mobile_services (service_name, users, user_attraction) VALUES('{service_name}', {user_id}, {user_attraction})""")
